...
ALLOWED_HOSTS = [os.environ.get("APP_HOST_IP", "localhost")]
...
CSRF_TRUSTED_ORIGINS = [
    f"""http://{os.environ.get("APP_HOST_IP", "localhost")}:{os.environ.get("APP_HOST_PROT", "8000")}"""
]
...
CART_KEY = os.environ.get("DJANGO_CART_KEY", "")
...
EMAIL_HOST_USER = os.environ.get("DJANGO_EMAIL_USER", "")  #寄件者電子郵件
EMAIL_HOST_PASSWORD = os.environ.get("DJANGO_EMAIL_PASSWORD", "")  #Gmail應用程式的密碼
